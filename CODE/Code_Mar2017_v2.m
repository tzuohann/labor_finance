...
%Run this code, take solutions as given, and write different functions to
%verify eqbm conditions in the paper
...
function ResultingW = calculateW(wages,separationProb,productivityProcess,U)
end

function ResultingU = calculateU(.,.,.,)
end

function ResultingU = calculateV(.,.,.,)
end
